...
use Pmclain\AuthorizenetCim\Gateway\Validator\ResponseValidator\Authorize;
...
class AuthorizeTest extends \PHPUnit\Framework\TestCase
{
  ...
  public function setUp()
  {
    ...
    $this->authorizeValidator = $objectManager->getObject(Authorize::class,
      [
  ...
  public function testValidate()
  {
    ...
    $this->authorizeValidator->validate($subject);
  }
