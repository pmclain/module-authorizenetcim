...
composer require pmclain/magento2-authorizenetcim:dev-master#$TRAVIS_COMMIT

# prepare for test suite
case $TEST_SUITE in
    integration)
        cp vendor/pmclain/magento2-authorizenetcim/Test/Integration/phpunit.xml.dist dev/tests/integration/phpunit.xml
    ...
    static)
        ...
        ;;
    unit)
        cp vendor/pmclain/magento2-authorizenetcim/Test/Unit/phpunit.xml.dist dev/tests/unit/phpunit.xml
    ;;
esac
